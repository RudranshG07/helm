...
export const SCENARIOS: Scenario[] = [
  ...
  { id: 'J5', category: 'Not yet built', title: 'No backtest has been run', expectation: 'Historical replay scoring the policy against outcomes that already happened.', outcome: 'UNHANDLED', note: 'The harness does not exist. Without it there is no number comparing this policy to the default schedule, which is the artifact a merchant would need before granting write access.' },
