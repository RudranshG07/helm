...
function setupSightSlider() {
  if (!sightsTrack || originalSightCount === 0) return;
...
function update() {
  ...
  root.style.setProperty("--four-y", `${(10 + progress * 10).toFixed(3)}vh`);
  root.style.setProperty("--four-scale", (0.78 + progress * 0.16).toFixed(4));
  root.style.setProperty("--bazaar-y", `${(20 - progress * 8).toFixed(3)}vh`);
  ...
  root.style.setProperty("--bridge-bottom", `${(5 - frame2.enter * 13).toFixed(3)}vh`);
  root.style.setProperty("--bridge-width", `${(67.2 + frame2.enter * 37.8).toFixed(3)}vw`);
  root.style.setProperty("--bridge-scale", (1.02 + sharedHeroScale + frame2.exit * 0.46).toFixed(4));

  root.style.setProperty("--split-left-x", `calc(-50% + ${(-splitDrift * 46).toFixed(3)}vw + ${(mouseX * 22).toFixed(2)}px)`);
  ...
  root.style.setProperty("--split-right-x", `calc(-50% + ${(splitDrift * 46).toFixed(3)}vw + ${(mouseX * 22).toFixed(2)}px)`);
  ...
  root.style.setProperty("--sights-enter-x", `${((1 - sightsEnter) * 420).toFixed(3)}vw`);
